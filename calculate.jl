...
function calculate(scheme::Discretization, init_cond_matrices; time_moments_to_make_shots=[], number_of_shots_per_time_moment::Int64=1, top_bc::Boundary_condition_Type=Neumann(), bottom_bc::Boundary_condition_Type=Neumann(), stop_function::Function=const_false_function)
    ...
    if isa(scheme.scheme_type, Implicit)
        ...
        @showprogress 1 "Computing..." for i = 1:N
            ...
            # Проверяем, выполняется ли условие для остановки расчета.
